    ...
    <div>
                    ...
                    <div class="col-xl-4">
                        <div class="mil-circle-illustration mil-with-dots-2 mil-mb-60" data-swiper-parallax-scale=".8">
                            ...
                            <div class="mil-image-frame">
                                <img src="img/faces/t8.jpeg"
                                    alt="Unified Communications"style="border-radius: 20%;transform:scale(0.5)">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-7">
                        <h2 class="mil-mb-30">Enhance Collaboration With <span class="mil-accent">Integrated Unified
                                Communications</span> Solutions</h2>
                        <div class="mil-hori-box mil-mb-30">
                            ...
                            <p>Our <span class="mil-accent">Unified Communications</span> solutions streamline
                                communication and collaboration across your organization, making it easier for teams to
                                connect, share information, and work together.</p>
                        </div>
        ...
        <section class="mil-p-120-90">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7">
                        <span class="mil-suptitle mil-suptitle-2 mil-mb-30">Discover Our Unified Communications
                            Services</span>
                        <h2 class="mil-mb-30">Explore Our <span class="mil-accent">Unified Communications
                                Solutions</span></h2>
                        <p class="mil-mb-90">We offer a range of Unified Communications services designed to improve
                            collaboration, efficiency, and productivity within your organization.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-4">
                    ...
                    <div class="col-xl-4">
                        <div class="mil-hover-card mil-box-center mil-mb-30">
                            ...
                            <p>Our contact center solutions provide advanced features for managing customer
                                interactions, including call routing, analytics, and reporting.</p>
                        </div>
                    </div>
                    <div class="col-xl-4">
                        <div class="mil-hover-card mil-box-center mil-mb-30">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-7">
                        ...
                        <h2 class="mil-mb-30">Expand Your <span class="mil-accent">Unified Communications
                                Capabilities</span></h2>
                        <p class="mil-mb-90">We offer a variety of solutions to enhance your unified communications
                            strategy and support your business growth.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-3 mil-mb-30">
                        ...
                        <p>Implement cloud-based communication solutions for flexibility and scalability, with features
                            like virtual phone systems and cloud storage.</p>
                    </div>
                    <div class="col-xl-3 mil-mb-30">
                        <div class="mil-deco mil-deco-accent" style="top: -10%; right: -10%;"></div>
                        <div class="mil-icon-frame mil-icon-frame-md mil-icon-bg mil-mb-30">
                        ...
                        <p>Enhance mobile communication with solutions that support remote work, including mobile apps,
                            secure access, and mobile device management.</p>
                    </div>
                    <div class="col-xl-3 mil-mb-30">
                        <div class="mil-deco mil-deco-accent" style="top: -10%; right: -10%;"></div>
                        <div class="mil-icon-frame mil-icon-frame-md mil-icon-bg mil-mb-30">
                        ...
                        <p>Advanced solutions for video and audio conferencing, offering high-definition meetings,
                            screen sharing, and integration with collaboration tools.</p>
                    </div>
                    <div class="col-xl-3 mil-mb-30">
                        <div class="mil-deco mil-deco-accent" style="top: -10%; right: -10%;"></div>
                        <div class="mil-icon-frame mil-icon-frame-md mil-icon-bg mil-mb-30">
                        ...
                        <p>Integrate your unified communications with CRM systems for better customer management,
