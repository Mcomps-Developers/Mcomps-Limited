            ...
            <div class="mil-banner-content">
                <div class="container mil-relative">
                    <ul class="mil-breadcrumbs mil-mb-30">
                        <li><a href="/">Home</a></li>
                        <li><a href="{{ route('service4') }}">Business Continuity & Cloud Services</a></li>
                    </ul>
                    <h2 class="mil-uppercase">Business Continuity <br> & Cloud Services</h2>
                </div>
            </div>
        </div>
        <!-- Banner End -->
        ...
        <section class="mil-p-120-90">
            ...
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-xl-7">
                        <h2 class="mil-mb-30">Ensure Your Business’s <span class="mil-accent">Continuity</span> with <span class="mil-accent">Comprehensive Cloud Solutions</span></h2>
